  ...
  rows: [
    {
      ...
      seats: "A, C, D, G",
      rating: "best",
      reason: "Extra legroom, direct aisle access, near galley",
    },
    {
      row: "12",
      seats: "A, K",
      rating: "best",
      reason: "Window seats with full privacy, no foot traffic",
    },
    {
      row: "14",
      seats: "D, G",
      rating: "good",
      reason: "Middle seats, good recline, near lavatory",
    },
    {
      row: "16",
      seats: "A, C, K",
      rating: "avoid",
      reason: "Near rear galley — noise & crew activity",
    },
    {
      row: "17",
      seats: "All",
      rating: "avoid",
      reason: "Misaligned windows, limited recline near exit",
    },
  ],
};
      ...
      >
        <div style={s.container}>
          ...
          <header style={s.header}>
            ...
            <p style={s.subtitle}>
              Enter your flight and cabin to see the best rows to sit in – and
              which rows to avoid.
            </p>
          </header>
          ...
          <div style={s.card}>
            <div style={s.row}>
              ...
              <div style={s.field}>
                ...
                />
                <span style={s.hint}>
                  Airline code + number (e.g., BA283, QR921, SQ317)
                </span>
              </div>
            ...
            <button
              ...
              style={{
                ...s.submitBtn,
                ...(isReady && !loading ? s.submitBtnReady : {}),
              }}
            >
              {loading ? (
                <span
              ...
              <div style={s.flightMeta}>
                <div style={s.metaLeft}>
                  ...
                  <div>
                    ...
                    <div style={s.metaSub}>
                      {results.aircraft} · {results.duration}
                    </div>
                  </div>
                </div>
              ...
              <div style={s.rowList}>
                {results.rows.map((r) => {
                  ...
                  return (
                    ...
                    >
                      <div style={s.rowLeft}>
                        <span style={{ ...s.rowNumber, color: cfg.color }}>
                          Row {r.row}
                        </span>
