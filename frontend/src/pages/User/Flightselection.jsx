          ...
          return (
            <Reveal key={card.title} delay={i * 100}>
              <div
                ...
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#B8DDED] to-[#7DC4E0]
                               flex items-center justify-center text-[26px] mb-6 text-[#0D2D44]">
                  <Icon />
                </div>
                <p className="text-xl font-semibold text-[#0D2D44] mb-3">{card.title}</p>
                <p className="text-sm leading-[1.8] text-[#2E5470] font-light flex-1">{card.desc}</p>
                <div className="mt-7 pt-6 border-t border-[rgba(74,157,189,0.15)]">
                  <span className="inline-flex items-center gap-2 text-[13px] font-medium text-[#4A9DBD]
