...
export default function Landing() {
  ...
  useEffect(() => {
   ...
   useEffect(() => {
    const handleScroll = () => {
      const sections = [
        "home", "features", "monitor", "flights", "services", "about", "contact",
      ];
      let current = "home";
      sections.forEach((id) => {
    ...
    <div className="font-body bg-[#F5F9FC] text-[#0A1E2D] overflow-x-hidden">
      ...
      >
        <div className="relative overflow-hidden">
          ...
          >
            <p className="text-[10.5px] uppercase tracking-[0.8px] text-[#6B98B8] mb-1">Today's Flights</p>
            <p className="text-[22px] font-semibold text-[#0D2D44]">128 Flights</p>
            <p className="text-[11px] text-[#2E5470] mt-0.5">↑ 12% increase in operations</p>
          </div>
          ...
          >
            <p className="text-[10.5px] uppercase tracking-[0.8px] text-[#6B98B8] mb-1">Safety Index</p>
            <p className="text-[22px] font-semibold text-[#0D2D44]">9.7 / 10</p>
            <p className="text-[11px] text-[#2E5470] mt-0.5">Excellent — Fully compliant operations</p>
          </div>
        ...
        <div className="relative flex flex-col justify-center px-16 py-10">
          ...
          <div className="flex items-center gap-2 mb-7 anim-hero" style={{ animationDelay: "0.1s" }}>
          ...
          <div className="flex items-center gap-4 anim-hero" style={{ animationDelay: "0.4s" }}>
            <a
          ...
          {features.map((f, i) => (
            <Reveal key={f.name} delay={i * 80}>
              ...
              >
                ...
                <p className="text-lg font-semibold text-[#0D2D44] mb-2">{f.name}</p>
                <p className="text-sm leading-relaxed text-[#2E5470] font-light">{f.desc}</p>
              </div>
            </Reveal>
          ))}
        </div>
          ...
          >
            {(visible) => (
              <>
                ...
                <p className="text-xs uppercase tracking-[0.8px] text-white/55">{m.label}</p>
              </>
            )}
          </Reveal>
        ))}
      ...
      <section id="monitor" className="bg-[#F5F9FC] px-14 py-24 relative overflow-hidden">
        <div
              ...
              {steps.map((s, i) => (
                <Reveal key={s.num} delay={i * 80}>
                  ...
                  >
                    ...
                    <div>
                      <p className="text-xl font-semibold text-[#0D2D44] mb-1.5">{s.title}</p>
                      <p className="text-base text-[#2E5470] leading-relaxed font-light">{s.text}</p>
                    </div>
                  </div>
                </Reveal>
              ))}
              ...
              >
                ...
                <div className="bg-[#0D2D44] px-5 py-3 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-white/40 text-[11px] tracking-wide">flystack.app/dashboard</span>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-white/30 text-[11px]">Jun 01, 2026</span>
                  </div>
                </div>
                ...
                <div className="bg-[#F0F7FB] p-4 flex flex-col gap-3">
                  ...
                  <div className="grid grid-cols-4 gap-2.5">
                    {[
                      { label: "Today's Flights", value: "128", delta: "↑ 12%", good: true, icon: "✈️" },
                      { label: "On-Time Rate",    value: "96%", delta: "↑ 2%",  good: true, icon: "⏱️" },
                      { label: "Revenue",         value: "$2.4M", delta: "↑ 8%", good: true, icon: "💰" },
                      { label: "Alerts",          value: "3 Active", delta: "↓ 5", good: true, icon: "🔔" },
                    ].map((k) => (
                      <div
                        key={k.label}
                        ...
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span
                            className={`text-[9px] font-medium px-1.5 py-0.5 rounded-full ${
                              k.good ? "bg-emerald-50 text-emerald-600" : "bg-red-50 text-red-500"
                            }`}
                          >
                            {k.delta}
                          </span>
                        </div>
                        <p className="text-[14px] font-bold text-[#0D2D44] leading-none">{k.value}</p>
                        <p className="text-[9px] text-[#6B98B8] mt-1 uppercase tracking-wide">{k.label}</p>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="grid grid-cols-5 gap-2.5">
                    ...
                    <div className="col-span-3 bg-white rounded-xl p-3.5 border border-[rgba(74,157,189,0.12)] shadow-[0_2px_8px_rgba(13,45,68,0.05)]">
                      <div className="flex items-center justify-between mb-2.5">
                        <div>
                          <p className="text-[11px] font-semibold text-[#0D2D44]">Weekly Flights</p>
                          <p className="text-[9px] text-[#6B98B8]">Departures per day</p>
                        </div>
                          ...
                          {["W", "M", "Y"].map((t) => (
                            <span
                              ...
                              className={`text-[9px] px-2 py-0.5 rounded cursor-pointer font-medium ${
                                t === "W" ? "bg-[#0D2D44] text-white" : "text-[#6B98B8] hover:bg-[#EDF6FB]"
                              }`}
                            >
                              {t}
                            </span>
                      ...
                      <svg viewBox="0 0 260 80" className="w-full" style={{ height: 80 }}>
                        {[0, 26, 53, 80].map((y) => (
                          <line key={y} x1="0" y1={y} x2="260" y2={y} stroke="#E8F4FA" strokeWidth="1" />
                        ))}
                        {[
                          { x: 8,   h: 48, day: "Mon" },
                          { x: 46,  h: 62, day: "Tue" },
                          ...
                          <g key={b.day}>
                            <rect x={b.x} y={80 - b.h} width="18" height={b.h} rx="3"
                              fill={b.active ? "#0D2D44" : "#B8DDED"} opacity={b.active ? 1 : 0.85} />
                            <text x={b.x + 9} y="92" textAnchor="middle" fontSize="6.5" fill="#6B98B8">
                              {b.day}
                            </text>
                          </g>
                        ))}
                        <polyline
                          ...
                          fill="none" stroke="#4A9DBD" strokeWidth="1.5" strokeDasharray="3 2" opacity="0.6"
                        />
                      </svg>
                    </div>
                    ...
                    <div className="col-span-2 bg-white rounded-xl p-3.5 border border-[rgba(74,157,189,0.12)] shadow-[0_2px_8px_rgba(13,45,68,0.05)] flex flex-col gap-2.5">
                      <div>
                        <p className="text-[11px] font-semibold text-[#0D2D44]">Route Performance</p>
                        <p className="text-[9px] text-[#6B98B8]">Top routes</p>
                      </div>
                      {[
                        { label: "CMB → DXB", value: "98%", fill: 98, color: "#7DC4E0" },
                        { label: "CMB → SIN", value: "94%", fill: 94, color: "#4AE09D" },
                        { label: "CMB → BKK", value: "89%", fill: 89, color: "#4A9DBD" },
                        { label: "CMB → LHR", value: "91%", fill: 91, color: "#B8DDED" },
                      ].map((q) => (
                        <div key={q.label}>
                          <div className="flex justify-between mb-1">
                            <span className="text-[9.5px] text-[#2E5470] font-medium">{q.label}</span>
                            <span className="text-[9.5px] font-semibold text-[#0D2D44]">{q.value}</span>
                          </div>
                          <div className="h-1.5 bg-[#EDF6FB] rounded-full overflow-hidden">
                            <div className="h-full rounded-full" style={{ width: `${q.fill}%`, background: q.color }} />
                          </div>
                        </div>
                      ))}
                    </div>
                  ...
                  <div className="grid grid-cols-3 gap-2.5">
                    ...
                    <div className="bg-white rounded-xl p-3.5 border border-[rgba(74,157,189,0.12)] shadow-[0_2px_8px_rgba(13,45,68,0.05)]">
                      <p className="text-[11px] font-semibold text-[#0D2D44] mb-0.5">Revenue Today</p>
                      <p className="text-[9px] text-[#6B98B8] mb-2.5">June 01, 2026</p>
                        ...
                        {[
                          ...
                          <div key={b.label}>
                            <div className="flex justify-between mb-0.5">
                              <span className="text-[9px] text-[#6B98B8]">{b.label}</span>
                              <span className="text-[9px] font-medium text-[#0D2D44]">{b.amt}</span>
                            </div>
                            <div className="h-1 bg-[#EDF6FB] rounded-full overflow-hidden">
                              <div className="h-full bg-[#7DC4E0] rounded-full" style={{ width: b.w }} />
                            </div>
                          </div>
                        ))}
                        <div className="flex justify-between pt-2 border-t border-[#EDF6FB]">
                          <span className="text-[10px] font-semibold text-[#0D2D44]">Total</span>
                          <span className="text-[10px] font-bold text-[#0D2D44]">$2.4M</span>
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Alerts */}
                    <div className="bg-white rounded-xl p-3.5 border border-[rgba(74,157,189,0.12)] shadow-[0_2px_8px_rgba(13,45,68,0.05)]">
                      <p className="text-[11px] font-semibold text-[#0D2D44] mb-2.5">Operational Alerts</p>
                      <div className="flex flex-col gap-2.5">
                        {[
                          { dot: "#4AE09D", title: "All Systems Normal",  time: "2 min ago", desc: "No critical issues detected" },
                          { dot: "#FEBC2E", title: "Weather Hold — BKK",  time: "1 hr ago",  desc: "FS108 delayed 45 min" },
                          { dot: "#4AE09D", title: "On-Time Milestone",   time: "Today",     desc: "96% OTP achieved this week" },
                        ].map((a) => (
                          <div key={a.title} className="flex gap-2 items-start">
                            <span className="mt-1 w-2 h-2 rounded-full flex-shrink-0" style={{ background: a.dot }} />
                            <div>
                              <p className="text-[10px] font-semibold text-[#0D2D44] leading-tight">{a.title}</p>
                              <p className="text-[9px] text-[#6B98B8]">{a.time} · {a.desc}</p>
                            </div>
                          </div>
                        ))}
                      </div>
                    ...
                    <div className="bg-gradient-to-br from-[#0D2D44] to-[#1A4A6B] rounded-xl p-3.5">
                      <p className="text-[11px] font-semibold text-white mb-0.5">Live Flights</p>
                      <p className="text-[9px] text-white/50 mb-2.5">Currently airborne</p>
                      <div className="text-center mb-2.5">
                        <p className="font-display font-light text-[34px] text-[#B8DDED] leading-none">74</p>
                        <p className="text-[8.5px] text-white/50 uppercase tracking-wide mt-1">In the air now</p>
                      </div>
                      <div className="bg-white/10 rounded-lg h-1.5 mb-1">
                        <div className="h-full bg-[#7DC4E0] rounded-lg" style={{ width: "58%" }} />
                      </div>
                      <p className="text-[8.5px] text-white/40 text-center mb-2.5">58% of fleet active</p>
                      <div className="grid grid-cols-2 gap-1.5">
                        {[
                          { emoji: "🛫", label: "FS402 departed CMB on schedule" },
                          { emoji: "🛩️", label: "FS108 delay: weather hold BKK" },
                        ].map((r) => (
                          <div key={r.label} className="bg-white/10 rounded-lg px-2 py-1.5 text-center">
                            <p className="text-[13px]">{r.emoji}</p>
                            <p className="text-[8px] text-white/60 mt-0.5">{r.label}</p>
                          </div>
                        ))}
                      </div>
                    </div>
        ...
        <Reveal>
          ...
          >
            ...
            <p className="text-base text-white/55 font-light max-w-md mx-auto mb-11">
              Join 340+ airlines already running smarter operations with FlyStack. No long onboarding. No lock-in.
            </p>
            <div className="flex justify-center gap-3.5">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-8 py-4 rounded-xl
                           border border-white/30 text-white text-[15px] font-light no-underline
                           hover:border-white/70 hover:bg-white/6 transition-all cursor-pointer"
              >
                Sign Up Free
              </a>
            </div>
